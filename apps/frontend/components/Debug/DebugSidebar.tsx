      ...
      {!meta && (
        <div className="p-3">
          ...
          <p className="text-xs text-muted mt-1">
            Enviá un mensaje para ver herramientas invocadas, tiempos y tokens. Este panel permanece visible
            para mantener consistencia del layout.
          </p>
          <ul className="text-xs list-disc pl-5 mt-2 text-muted">
            <li>Fuente (GitHub) se mostrará cuando el bot use el dataset semilla.</li>
            <li>Timings aparecen tras la primera respuesta (initial y followup).</li>
        ...
        <div className="p-3 text-sm">
          ...
          <div className="mb-3">
            ...
            <span className="text-muted">
              initial {meta.timings?.initialMs ?? '—'}ms · followup {meta.timings?.followupMs ?? '—'}ms
            </span>
          </div>
          ...
          <div className="mb-3">
            ...
            <div className="flex flex-col gap-2">
              {!meta.tools || meta.tools.length === 0 ? (
                <div className="text-xs text-muted">sin tools en este turno</div>
              ) : (
                meta.tools.map((ev, i) => (
